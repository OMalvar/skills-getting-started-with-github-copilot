...
activities = {
    ...
    "Soccer Club": {
        "description": "Recreational soccer for fitness and teamwork",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["lucas@mergington.edu", "noah@mergington.edu"]
    },
    "Music Band": {
        "description": "Learn and perform in the school concert band",
    ...
    "Art Studio": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["ava@mergington.edu", "maya@mergington.edu"]
    },
    "Debate Club": {
